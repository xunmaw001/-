<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="作品类型" prop="zuopinleixing">
					<el-input v-model="ruleForm.zuopinleixing" placeholder="作品类型" clearable  :readonly="ro.zuopinleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="作品类型" prop="zuopinleixing">
					<el-input v-model="ruleForm.zuopinleixing" placeholder="作品类型" readonly></el-input>
				</el-form-item>
			</template>
